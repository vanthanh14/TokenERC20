...
interface IERC20 {
    ...
    function transferFrom(address from, address to, uint256 numTokens) external returns (bool);
    ...
    event Approval(address indexed owner, address indexed spender, uint256 numTokens);
}
